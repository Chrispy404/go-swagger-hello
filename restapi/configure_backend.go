...
import (
	...
	"github.com/chrispy404/go-swagger-hello/restapi/operations"
	"github.com/chrispy404/go-swagger-hello/restapi/operations/hello"
)
...
func configureAPI(api *operations.BackendAPI) http.Handler {
	...
	if api.HelloSayHelloHandler == nil {
		api.HelloSayHelloHandler = hello.SayHelloHandlerFunc(func(params hello.SayHelloParams) middleware.Responder {
			return middleware.NotImplemented("operation hello.SayHello has not yet been implemented")
		})
	}
