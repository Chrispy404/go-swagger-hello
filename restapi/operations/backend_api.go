...
func NewBackendAPI(spec *loads.Document) *BackendAPI {
	return &BackendAPI{
		...
		HelloSayHelloHandler: hello.SayHelloHandlerFunc(func(params hello.SayHelloParams) middleware.Responder {
			return middleware.NotImplemented("operation hello.SayHello has not yet been implemented")
		}),
	}
}

/*BackendAPI the backend API */
type BackendAPI struct {
	...
	// HelloSayHelloHandler sets the operation handler for the say hello operation
	HelloSayHelloHandler hello.SayHelloHandler
...
func (o *BackendAPI) Validate() error {
	...
	if o.HelloSayHelloHandler == nil {
		unregistered = append(unregistered, "hello.SayHelloHandler")
	}
...
func (o *BackendAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/hello"] = hello.NewSayHello(o.context, o.HelloSayHelloHandler)
}
